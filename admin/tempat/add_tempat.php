	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="kode_tempat" name="kode_tempat" placeholder="Kode Tempat" required>
				</div>
			</div>
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_tempat (kode_tempat, tempat, alamat, desa_kelurahan, kecamatan, kabupaten_kota) VALUES (
            '".$_POST['kode_tempat']."',
			'".$_POST['tempat']."',
			'".$_POST['alamat']."',
